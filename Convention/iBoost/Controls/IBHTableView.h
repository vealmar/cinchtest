...
@interface IBHTableView : UIScrollView {
	//external
	id<IBHTableViewDataSource> __unsafe_unretained _dataSource;
...
@property(nonatomic, unsafe_unretained) id<IBHTableViewDelegate> delegate;
@property(nonatomic, unsafe_unretained) id<IBHTableViewDataSource> dataSource;
